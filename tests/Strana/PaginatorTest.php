...
class PaginatorTest extends TestCase
{
    ...
    public function testHTMLOutput()
    {
        ...
        $expected = '<ul class="pagination"><li class=""><a class="prev" href="?page=3">&laquo;</a></li><li class=""><a href="?page=2">2</a></li><li class=""><a href="?page=3">3</a></li><li class="active"><a href="?page=4">4</a></li><li class=""><a href="?page=5">5</a></li><li class=""><a href="?page=6">6</a></li><li class=""><a class="next" href="?page=5">&raquo;</a></li></ul>';
